...
const ProjectTile = ({ name }: { name: string }) => {
  ...
  return (
    ...
    >
      <div className="flex h-5/6 w-5/6 flex-col rounded-md border-2 border-red-700 bg-red-500/75 p-2">
        ...
        <div className="flex h-1/6 items-center px-2 text-lg font-semibold">
          {name}
        </div>
      </div>
    </div>
